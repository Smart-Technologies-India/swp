    ...
    for (
      ...
      buttons.push(
        <button
          ...
          className={`rounded-md border-2 border-gray-500 hover:border-blue-500 hover:text-blue-500 text-sm text-center w-8 h-8 grid place-items-center ${
            props.activePage === i
    ...
    if (props.activePage - maxButtonsToShow > 1) {
      buttons.unshift(
        <button
          key="left-ellipsis"
          disabled
          className="rounded-md text-sm text-center w-8 h-8 grid place-items-center cursor-not-allowed"
        >
          ...
        </button>
      );
        ...
        <div className="flex gap-2 items-center">
          <div className="relative">
            <div
              ...
              className="px-2 h-7 text-sm text-black font-normal text-center rounded-md border-2 border-gray-500 hover hover:border-blue-500 flex gap-1 items-center w-32 cursor-pointer"
            >
          ...
          <div className="flex gap-2 items-center">
            ...
            <input
              ...
              className="text-black border-2 border-gray-400 focus:border-blue-500 px-2 rounded-md w-14 outline-none"
            />
