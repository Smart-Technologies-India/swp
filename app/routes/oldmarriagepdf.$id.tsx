  ...
  const MarriagePdf = () => (
    <Document>
      <Page style={styles.body} size={"A4"}>
        ...
        <View>
          <Text style={styles.heading}>Sub Registrar,</Text>
        </View>
        <View>
          <Text style={styles.heading}>
        ...
        <View>
          <Text style={styles.heading}>New Marriage Registration</Text>
        </View>
        <View>
          <Text style={styles.subtitle} fixed>
            With reference to the {form.id}, the Marriage Registration for
            applicant of village {village}
          </Text>
        </View>
        <View>
          <Text style={styles.subtitle} fixed>
        ...
        <View>
          <Text style={styles.signtext}>
            &nbsp; &nbsp; &nbsp; &nbsp; The Marriage Registration pertaining to
            applicant based in village {village.name} is hereby Granted.
          </Text>
        </View>
