...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({
    id: id,
    user: cookie,
    form: data.data.getWaterSizeChangeById,
    village: village.data.getAllVillageById.name,
    common: common.data.searchCommon,
  });
};

const WaterSizeChangePdfView = (): JSX.Element => {
    ...
    <Document>
      <Page style={styles.body} size={"A4"}>
        <View style={styles.page}>
          ...
          <View>
            <Text style={styles.title}>WATER SIZE CHANGE CERTIFICATE</Text>
          </View>
...
export default WaterSizeChangePdfView;
