...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  const data = await ApiCall({
    query: `
        query getMarriageCertificateById($id:Int!){
            getMarriageCertificateById(id:$id){
              id,
              name,
              address,
              mobile,
  ...
  const village = await ApiCall({
    query: `
      ...
      `,
    veriables: {
      id: parseInt(data.data.getMarriageCertificateById.village_id),
    },
  });
  ...
  const searchpayment = await ApiCall({
    ...
    veriables: {
      searchPaymentInput: {
        form_id: parseInt(data.data.getMarriageCertificateById.id),
        form_type: "MARRIAGECERT",
      },
    },
  });
  return json({
    user: cookie,
    formid: id,
    from_data: data.data.getMarriageCertificateById,
...
const MarriageCertificateView = (): JSX.Element => {
      ...
      if (!addpayment.status) {
        ...
        if (data.status) {
          ...
          const savepaymentdoc = await ApiCall({
            query: `
                        mutation updateMarriageCertificateById($updateMarriageCertificateInput:UpdateMarriageCertificateInput!){
                            updateMarriageCertificateById(updateMarriageCertificateInput:$updateMarriageCertificateInput){
                              id,
                            }
                          }
                        `,
            veriables: {
              updateMarriageCertificateInput: payreq,
            },
          });
    ...
    <>
      ...
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        <h1 className="text-gray-800 text-3xl font-semibold text-center">
          Marriage Certificate Re-Issue Application
        </h1>
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          Format of Application for obtaining old Marriage certificate.{" "}
        </p>
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.2</span> Bridegroom address
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
            {from_data.address}
          </div>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.3</span> Bridegroom Contact Number
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
            {from_data.mobile}
          </div>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.4</span> Bridegroom Email
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
            {from_data.email}
          </div>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.8</span> Bride Name
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.9</span> Bride Father Name
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.10</span> Bride Mother Name
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">2.11</span> Registration Number
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
        ...
        <>
          ...
          <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
            <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
              <span className="mr-2">3.1</span> Bridegroom UIDAI Aadhaar Upload
          ...
          <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
            <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
              <span className="mr-2">3.2</span> Bridegroom Father UIDAI Upload
              <p className="text-rose-500 text-sm">
                ( Maximum Upload Size 2MB & Allowed Format JPG / PDF / PNG )
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
            <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
              <span className="mr-2">3.3</span> Bridegroom Mother UIDAI Upload
              <p className="text-rose-500 text-sm">
                ( Maximum Upload Size 2MB & Allowed Format JPG / PDF / PNG )
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
            <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
              <span className="mr-2">3.2</span> Bride Father UIDAI Upload
              <p className="text-rose-500 text-sm">
                ( Maximum Upload Size 2MB & Allowed Format JPG / PDF / PNG )
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
            <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
              <span className="mr-2">3.7</span> Undertaking
              <p className="text-rose-500 text-sm">
                ( Maximum Upload Size 2MB & Allowed Format JPG / PDF / PNG )
              </p>
            </div>
                ...
                {common.query_status == "REJECTED" ? null : (
                  <>
                    ...
                    {common.form_status == 50 && user.id == 5 ? (
                      <button
                        onClick={() => {
                          forwardRef!.current!.value = `The Marriage Certificate documents requested as per application number ${from_data.id} pertaining to your request is as attached below.`;
                          setForwardBox((val) => true);
                          setNextData((val) => ({
