...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({
    id: id,
    user: cookie,
    form: data.data.getPermanentWaterDisconnectById,
    village: village.data.getAllVillageById.name,
    common: common.data.searchCommon,
  });
};

const PermanentWaterDisconnectPdfView = (): JSX.Element => {
  ...
  const PermanenetWaterDisconnectPdf = () => (
    <Document>
        ...
        <View style={styles.page}>
          ...
          <View>
            <Text style={styles.title}>
              PERMANENT WATER DISCONNECTION CERTIFICATE
            </Text>
          </View>
...
export default PermanentWaterDisconnectPdfView;
