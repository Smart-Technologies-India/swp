    ...
    if (!addpayment.status) {
      ...
      if (data.status) {
        ...
        const savepaymentdoc = await ApiCall({
          query: `
                        mutation updateWaterReconnectById($updateWaterReconnectInput:UpdateWaterReconnectInput!){
                            updateWaterReconnectById(updateWaterReconnectInput:$updateWaterReconnectInput){
                              id,
                            }
                          }
                        `,
