      ...
      <div className="bg-white p-8 shadow rounded-md w-full mt-3">
        <section className="mb-8">
          <p className="text-lg mt-2">
            ...
            https://s2.dddgov.in, or the Sugam Citizen Service Web Application
            application (collectively, “Sugam Platform”) made available
            by District Industries Center ,Daman (“DIC Daman”, “Company”,
            “we”, “us” and “our”), a Government establishment established under
            the laws of India having its registered office at Second Floor, District Secretariat,
          Daman-396191.
          </p>
          <p className="text-lg mt-2">
            The terms “you” and “your” refer to the user of the Sugam
            Platform. The term “Services” refers to any services offered by DIC whether on the Sugam Platform or otherwise.
          </p>
          <p className="text-lg mt-2">
            Please read this Policy before using the Sugam Platform or
            submitting any personal information to DIC. This Policy is a
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            By using the Sugam Platform and the Services, you agree and
            ...
            please do not use or access the Sugam Platform.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            such changes, such as via prominent notice on the Sugam
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            Our Sugam Platform and third parties with whom we partner,
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            features to personalise your Sugam account;
          </p>
          <p className="text-lg mt-2">
          ...
          <p className="text-lg mt-2">
            To administer and enhance the security of our Sugam Platform
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            password which enables you to access certain parts of the Sugam Platform, you are responsible for keeping these details
          ...
          <p className="text-lg mt-2">
            ...
            data transmitted through the Sugam Platform. Once we have
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            dic-dd@nic.in. Please note that we may take time to process such
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
            9. GRIEVANCE OFFICER AND Sugam PLATFORM SECURITY
          </h2>
          <p className="text-lg mt-2">
            ...
            email us at dic-dd@nic.in or write to our Grievance
            Officer at the following address:
          </p>
          <p className="text-lg mt-2">
            If you come across any abuse or violation of the Policy, please
            report to dic-dd@nic.in.
          </p>
          <p className="text-lg mt-2">
            Further, please note that the Sugam Platform stores your data
            ...
            https://hostinger.com/. The privacy policy adopted by Hostinger Web
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">Contact: 0260-2260310 / 2260871</p>
          <p className="text-lg">Email: dic-dd@nic.in</p>
        </section>
      </div>
    </div>
  );
