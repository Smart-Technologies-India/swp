...
const WaterSizeChange: React.FC = (): JSX.Element => {
  ...
  const submit = async () => {
    ...
    type WaterSizeChangeScheme = z.infer<typeof WaterSizeChangeScheme>;

    const waterSizeChangeScheme: WaterSizeChangeScheme = {
    ...
    const parsed = WaterSizeChangeScheme.safeParse(waterSizeChangeScheme);
    ...
    if (parsed.success) {
      ...
      if (
        ...
        const data = await ApiCall({
          query: `
              mutation createWaterSizeChange($createWaterSizeChangeInput:CreateWaterSizeChangeInput!){
                createWaterSizeChange(createWaterSizeChangeInput:$createWaterSizeChangeInput){
                    id
                  }
                }
              `,
          veriables: {
            createWaterSizeChangeInput: {
              ...
              name: waterSizeChangeScheme.name,
              address: waterSizeChangeScheme.address,
              email: waterSizeChangeScheme.email,
              mobile: waterSizeChangeScheme.mobile,
              user_uid: waterSizeChangeScheme.user_uid,
              village_id: waterSizeChangeScheme.village_id,
              ward_number: waterSizeChangeScheme.ward_number,
              ...
              iagree: waterSizeChangeScheme.iagree,
              status: "ACTIVE",
              
            
              connection_type: waterSizeChangeScheme.connection_type,
              entity_type: waterSizeChangeScheme.entity_type,
              muncipal_type: waterSizeChangeScheme.muncipal_type,
              ownership_type: waterSizeChangeScheme.ownership_type,
    ...
    <>
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        <h1 className="text-gray-800 text-3xl font-semibold text-center">
          Water Connection Size Change Application
        </h1>
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          Format of Application for Water Connection Size Change.{" "}
        </p>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">3.5</span> Old Diameter Of connection
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto">
            <input
              ref={oldDiameterRef}
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">3.6</span> New Diameter Of connection
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto">
            <input
              ref={newDiameterRef}
...
export default WaterSizeChange;
