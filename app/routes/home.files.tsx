...
const Dashboard: React.FC = (): JSX.Element => {
  ...
  const getUserfromId = (userid: number): string => {
    ...
    if (14 == userid) return "Dept 5";
    if (15 == userid) return "Mamlatdar";
    if (16 == userid) return "EOCS";
    if (17 == userid) return "Dept 1";
    if (18 == userid) return "Dept 2";
    if (19 == userid) return "Dept 3";
    if (20 == userid) return "Dept 4";
    ...
    if (32 == userid) return "LDC";
    if (33 == userid) return "UDC";
    if (34 == userid) return "Dept 7";
    ...
    if (42 == userid) return "LDC";
    if (43 == userid) return "UDC";
    if (44 == userid) return "Dept 7";
    ...
    if (52 == userid) return "LDC";
    if (53 == userid) return "UDC";
    if (54 == userid) return "Dept 7";
    ...
    if (62 == userid) return "LDC";
    if (63 == userid) return "UDC";
    if (64 == userid) return "Dept 7";
