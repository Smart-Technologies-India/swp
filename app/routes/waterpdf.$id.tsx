        ...
        <Page style={styles.body} size={"A4"}>
          ...
          <View>
            <Text style={styles.subtitle} fixed>
              With reference to the {form.id}, a new water connection for given house number of village{" "}
              {village}
            </Text>
          </View>
          <View>
          ...
          <View>
            <Text style={styles.signtext}>
              &nbsp; &nbsp; &nbsp; &nbsp; A new Water connection             pertaining to given house number of village {village.name} is hereby Granted.
            </Text>
          </View>
