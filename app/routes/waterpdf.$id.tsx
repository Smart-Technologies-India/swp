...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  const village = await ApiCall({
    query: `
        ...
        `,
    veriables: {
      id: parseInt(data.data.getWaterById.village_id!),
    },
  });
  ...
  const WaterPdf = () => (
    <Document>
      <Page style={styles.body} size={"A4"}>
        ...
        <View>
          <Text style={styles.heading}>Public Works Department,</Text>
        </View>
        <View>
          <Text style={styles.heading}>PWD Office, Moti Daman.</Text>
        </View>
        <View>
          <Text style={styles.heading}>New Water Connection</Text>
        </View>
        <View>
          <Text style={styles.subtitle} fixed>
            With reference to the {form.id}, a new water connection for given
            house number of village {village}
          </Text>
        </View>
        <View>
          <Text style={styles.subtitle} fixed>
        ...
        <View>
          <Text style={styles.signtext}>
            &nbsp; &nbsp; &nbsp; &nbsp; A new Water connection pertaining to
            given house number of village {village.name} is hereby Granted.
          </Text>
        </View>
        <View style={styles.flexbox}>
          ...
          <View style={styles.flexbox3}>
            <View>
              ...
              <Text style={styles.signtext}>CEO(PWD)</Text>
