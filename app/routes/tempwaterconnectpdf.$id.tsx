...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({
    id: id,
    user: cookie,
    form: data.data.getTempWaterConnectById,
    village: village.data.getAllVillageById.name,
    common: common.data.searchCommon,
  });
};

const TempWaterConnectPdfView = (): JSX.Element => {
        ...
        <View style={styles.page}>
          ...
          <View>
            <Text style={styles.title}>
              TEMPORARY WATER CONNECTION CERTIFICATE
            </Text>
          </View>
...
export default TempWaterConnectPdfView;
