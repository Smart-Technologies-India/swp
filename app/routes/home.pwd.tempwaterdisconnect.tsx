...
const TempWaterDisconnect: React.FC = (): JSX.Element => {
  ...
  const submit = async () => {
    const TempWaterDisconnectScheme = z
      .object({
    ...
    type TempWaterDisconnectScheme = z.infer<typeof TempWaterDisconnectScheme>;

    const tempWaterDisconnectScheme: TempWaterDisconnectScheme = {
    ...
    const parsed = TempWaterDisconnectScheme.safeParse(tempWaterDisconnectScheme);
    ...
    if (parsed.success) {
      ...
      if (
        ...
        const data = await ApiCall({
          query: `
              mutation createTempWaterDisconnect($createTempWaterDisconnectInput:CreateTempWaterDisconnectInput!){
                createTempWaterDisconnect(createTempWaterDisconnectInput:$createTempWaterDisconnectInput){
                    id
                  }
                }
              `,
          veriables: {
            createTempWaterDisconnectInput: {
              ...
              name: tempWaterDisconnectScheme.name,
              address: tempWaterDisconnectScheme.address,
              email: tempWaterDisconnectScheme.email,
              mobile: tempWaterDisconnectScheme.mobile,
              user_uid: tempWaterDisconnectScheme.user_uid,
              village_id: tempWaterDisconnectScheme.village_id,
              ward_number: tempWaterDisconnectScheme.ward_number,
              meter_number: tempWaterDisconnectScheme.meter_number,
              purpose: tempWaterDisconnectScheme.purpose,
              ...
              iagree: tempWaterDisconnectScheme.iagree,
              status: "ACTIVE",
              from_date: tempWaterDisconnectScheme.from_date,
              to_date: tempWaterDisconnectScheme.to_date,
              connection_type: tempWaterDisconnectScheme.connection_type,
              entity_type: tempWaterDisconnectScheme.entity_type,
              muncipal_type: tempWaterDisconnectScheme.muncipal_type,
              ownership_type: tempWaterDisconnectScheme.ownership_type,
        ...
        if (!data.status) {
          ...
          navigator(
            `/home/pwd/tempwaterdisconnectview/${data.data.createTempWaterDisconnect.id}`
          );
        }
      } else {
    ...
    <>
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        <h1 className="text-gray-800 text-3xl font-semibold text-center">
          Temporary Water Disconnection Application
        </h1>
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          Format of Application for Temporary Water Disconnection.{" "}
        </p>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">3.6</span> Disconnection From Date
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto">
            <input
              type="date"
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700 ">
            <span className="mr-2">3.6</span> Disconnection To Date
          </div>
          <div className="flex-none lg:flex-1 w-full lg:w-auto">
            <input
              type="date"
...
export default TempWaterDisconnect;
