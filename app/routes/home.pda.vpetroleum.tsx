      ...
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        <div className="flex items-center gap-4">
          ...
          {user.id == 7 ? (
            <Link
              to={"/home/petroleum"}
              className="my-2 lg:my-auto lg:absolute right-0 top-0 py-2 inline-block w-full sm:w-auto text-white text-sm px-4 bg-green-500 text-center rounded-md font-medium"
            >
              Create Petroleum Form
            </Link>
          ) : null}
          {isSearch ? (
            <>
                  ...
                  {pagination.paginatedItems.map((val: any, index: number) => {
                    return (
                      ...
                      >
                        ...
                        <td className="text-sm text-gray-900 font-medium px-4 py-2 whitespace-nowrap">
                          <Link
                            to={`/home/pda/petroleumview/${val.form_id}`}
