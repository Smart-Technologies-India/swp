...
const Dealinghand = (): JSX.Element => {
  ...
  useEffect(() => {
    for (let i: number = 0; i < dealinghand.length; i++) {
      ...
      for (const key in dealinghand[i]) {
        if (
          dealinghand[i].hasOwnProperty(key) &&
          typeof dealinghand[i][key] === "boolean"
        ) {
  ...
  const getvalue = (index: number) => {
    ...
    for (const key in dealinghand[index]) {
      if (
        dealinghand[index].hasOwnProperty(key) &&
        typeof dealinghand[index][key] === "boolean"
      ) {
        ...
        <div className="overflow-x-auto sm:mx-0.5 my-2 p-4">
          <table className="min-w-full rounded-md">
            ...
            <tbody>
              {data.length == 0
                ? null
                : dealinghand.map((val: any, index: number) => {
                    return (
                      <tr
                        key={index}
                      ...
                      >
                        ...
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].collector}
                            onChange={(e) => {
                              handleToggle(index, "collector");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].dycollector}
                            onChange={(e) => {
                              handleToggle(index, "dycollector");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].atp}
                            onChange={(e) => {
                              handleToggle(index, "atp");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].jtp}
                            onChange={(e) => {
                              handleToggle(index, "jtp");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].je}
                            onChange={(e) => {
                              handleToggle(index, "je");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].fieldinspector}
                            onChange={(e) => {
                              handleToggle(index, "fieldinspector");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].sitesupervisor}
                            onChange={(e) => {
                              handleToggle(index, "sitesupervisor");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].architectassistant}
                            onChange={(e) => {
                              handleToggle(index, "architectassistant");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].planningdraughtsman}
                            onChange={(e) => {
                              handleToggle(index, "planningdraughtsman");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].spdraughtsman}
                            onChange={(e) => {
                              handleToggle(index, "spdraughtsman");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].stdraughtsman}
                            onChange={(e) => {
                              handleToggle(index, "stdraughtsman");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].landsupted}
                            onChange={(e) => {
                              handleToggle(index, "landsupted");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
                        <td className="text-center text-lg text-gray-900 font-medium px-6 py-4 whitespace-nowrap">
                          <input
                            type="checkbox"
                            checked={data[index].mamlatdar}
                            onChange={(e) => {
                              handleToggle(index, "mamlatdar");
                            }}
                            className="text-blue-600 bg-gray-100 border-gray-300 rounded scale-150"
                          />
                        </td>
