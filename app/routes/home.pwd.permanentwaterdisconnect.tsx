...
const PermanentWaterDisconnect: React.FC = (): JSX.Element => {
  ...
  const submit = async () => {
    const PermanentWaterDisconnectScheme = z
      .object({
    ...
    if (parsed.success) {
      ...
      if (
        ...
        const data = await ApiCall({
          query: `
              mutation createPermanentWaterDisconnect($createPermanentWaterDisconnectInput:CreatePermanentWaterDisconnectInput!){
                createPermanentWaterDisconnect(createPermanentWaterDisconnectInput:$createPermanentWaterDisconnectInput){
                    id
                  }
                }
              `,
          veriables: {
            createPermanentWaterDisconnectInput: {
              ...
              name: permanentWaterDisconnectScheme.name,
              address: permanentWaterDisconnectScheme.address,
              email: permanentWaterDisconnectScheme.email,
              mobile: permanentWaterDisconnectScheme.mobile,
              user_uid: permanentWaterDisconnectScheme.user_uid,
              village_id: permanentWaterDisconnectScheme.village_id,
              ward_number: permanentWaterDisconnectScheme.ward_number,
              meter_number: permanentWaterDisconnectScheme.meter_number,
              purpose: permanentWaterDisconnectScheme.purpose,
        ...
        if (!data.status) {
          ...
          navigator(
            `/home/pwd/permanentwaterdisconnectview/${data.data.createPermanentWaterDisconnect.id}`
          );
        }
      } else {
    ...
    <>
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        <h1 className="text-gray-800 text-3xl font-semibold text-center">
          Permanent Water Disconnection Application
        </h1>
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          Format of Application for Permanent Water Disconnection.{" "}
        </p>
...
export default PermanentWaterDisconnect;
