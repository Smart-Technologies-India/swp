...
const BirthCertificate: React.FC = (): JSX.Element => {
  ...
  const submit = async () => {
    const BirthCertificateScheme = z
      .object({
    ...
    type BirthCertificateScheme = z.infer<typeof BirthCertificateScheme>;

    const birthCertificateScheme: BirthCertificateScheme = {
    ...
    const parsed = BirthCertificateScheme.safeParse(birthCertificateScheme);
    ...
    if (parsed.success) {
      ...
      if (
        ...
        const data = await ApiCall({
          query: `
              mutation createBirthCertificate($createBirthCertificateInput:CreateBirthCertificateInput!){
                createBirthCertificate(createBirthCertificateInput:$createBirthCertificateInput){
                    id
                  }
                }
              `,
          veriables: {
            createBirthCertificateInput: {
              ...
              name: birthCertificateScheme.name,
              address: birthCertificateScheme.address,
              email: birthCertificateScheme.email,
              mobile: birthCertificateScheme.mobile,
              user_uid: birthCertificateScheme.user_uid,
              village_id: birthCertificateScheme.village_id,
              father_name: birthCertificateScheme.father_name,
              mother_name: birthCertificateScheme.mother_name,
              registration_number: birthCertificateScheme.registration_number,
              ...
              iagree: birthCertificateScheme.iagree,
              status: "ACTIVE",
              date_of_birth: birthCertificateScheme.date_of_birth,
              date_of_registration: birthCertificateScheme.date_of_registration,
              gender: birthCertificateScheme.gender,
            },
          },
        });
        if (!data.status) {
          ...
          navigator(
            `/home/crsr/birthcertview/${data.data.createBirthCertificate.id}`
          );
        }
      } else {
    ...
    <>
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          Format of Application for obtaining old Birth certificate.{" "}
        </p>
