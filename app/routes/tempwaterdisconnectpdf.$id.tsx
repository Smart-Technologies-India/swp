...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({
    id: id,
    user: cookie,
    form: data.data.getTempWaterDisconnectById,
    village: village.data.getAllVillageById.name,
    common: common.data.searchCommon,
  });
};

const TempWaterDisconnectPdfView = (): JSX.Element => {
        ...
        <View style={styles.page}>
          ...
          <View>
            <Text style={styles.title}>
              TEMPORARY WATER DISCONNECT CERTIFICATE
            </Text>
          </View>
...
export default TempWaterDisconnectPdfView;
