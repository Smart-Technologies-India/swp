  ...
  const CpPdf = () => (
    <Document>
      <Page style={styles.body} size={"A4"}>
        ...
        <View>
          <Text style={styles.heading}>Construction Certificate Permission</Text>
        </View>
        <View>
          <Text style={styles.subtitle} fixed>
            With reference to the {form.id}, the Construction Certificate
        ...
        <View>
          <Text style={styles.signtext}>
            &nbsp; &nbsp; &nbsp; &nbsp; The Construction Certificate permission
        ...
        <View style={styles.flexbox}>
          ...
          <View style={styles.flexbox3}>
            <View>
              ...
              <Text style={styles.signtext}>M.S(PDA)/ATP(PDA)</Text>
...
export default ConstructionPdfView;
