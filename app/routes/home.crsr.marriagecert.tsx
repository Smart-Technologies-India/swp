...
const MarriageCertificate: React.FC = (): JSX.Element => {
  ...
  const submit = async () => {
    const MarriageCertificateScheme = z
      .object({
    ...
    type MarriageCertificateScheme = z.infer<typeof MarriageCertificateScheme>;

    const marriageCertificateScheme: MarriageCertificateScheme = {
    ...
    if (parsed.success) {
      ...
      if (
        ...
        const data = await ApiCall({
          query: `
              mutation createMarriageCertificate($createMarriageCertificateInput:CreateMarriageCertificateInput!){
                createMarriageCertificate(createMarriageCertificateInput:$createMarriageCertificateInput){
                    id
                  }
                }
              `,
          veriables: {
            createMarriageCertificateInput: {
              ...
              name: marriageCertificateScheme.name,
              address: marriageCertificateScheme.address,
              email: marriageCertificateScheme.email,
        ...
        if (!data.status) {
          ...
          navigator(
            `/home/crsr/marriagecertview/${data.data.createMarriageCertificate.id}`
          );
        }
      } else {
