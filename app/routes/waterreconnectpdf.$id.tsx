...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({
    id: id,
    user: cookie,
    form: data.data.getWaterReconnectById,
    village: village.data.getAllVillageById.name,
    common: common.data.searchCommon,
  });
};

const WaterReconnectPdfView = (): JSX.Element => {
        ...
        <View style={styles.page}>
          ...
          <View>
            <Text style={styles.title}>
              WATER RECONNECTION CERTIFICATE
            </Text>
          </View>
...
export default WaterReconnectPdfView;
