...
import { z } from "zod";
import { CilContact, CilEnvelopeClosed } from "~/components/icons/icons";
    ...
    <>
      <div className="min-h-screen w-full bg-[#eeeeee] grid place-items-center">
        <div className="p-6 rounded-md shadow-md hover:shadow-xl hover:scale-105 transition-all bg-white border-t-4 border-purple-500 w-80">
          ...
          <p className="text-lg my-3 text-gray-700 text-center">
            Fill your relevant details.
          </p>
          ...
          <p className="text-left text-sm font-medium text-black mt-3">
            Aadhar Number
          </p>
          ...
          <div className="flex gap-4 items-center mt-4">
            ...
            <Link
              to="/home"
              className="bg-blue-500 rounded-md py-1 text-sm text-center text-white font-semibold flex-1 inline-block"
            >
              SKIP THIS STEP
            </Link>
          </div>
